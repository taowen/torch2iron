...
MLIR="${REPO_ROOT}/build/fast_qwen3_qwen3_layer_static_kv_one_pair_two_stage_attention_ingress_contract.mlir"
XCLBIN="${REPO_ROOT}/build/fast_qwen3_qwen3_layer_static_kv_one_pair_two_stage_attention_ingress_contract_run.xclbin"
INSTS="${REPO_ROOT}/build/fast_qwen3_qwen3_layer_static_kv_one_pair_two_stage_attention_ingress_contract_run.bin"

"${REPO_ROOT}/scripts/build_fast_qwen3_plane_attention_kernel_object.sh"
"${REPO_ROOT}/scripts/run_fast_qwen3_layer_static_kv_one_pair_two_stage_attention_ingress_contract_smoke.sh" \
  --attend-seq-len 128 \
  --tile-size 16 \
