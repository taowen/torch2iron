...
def build_decode_fused_op(config, prompt_len, build_suffix):
    ...
    fused_op = FusedMLIROperator(
        ...
        buffer_sizes={
            "packet_cache_0": packet_cache_buffer_size,
            "packet_cache_1": packet_cache_buffer_size,
            "packet_cache_2": packet_cache_buffer_size,
            "packet_cache_3": packet_cache_buffer_size,
            "packet_cache_4": packet_cache_buffer_size,
            "packet_cache_5": packet_cache_buffer_size,
            "packet_cache_6": packet_cache_buffer_size,
            "packet_cache_7": packet_cache_buffer_size,
            "packet_cache_8": packet_cache_buffer_size,
            "packet_cache_9": packet_cache_buffer_size,
            "packet_cache_10": packet_cache_buffer_size,
            "packet_cache_11": packet_cache_buffer_size,
            "packet_cache_12": packet_cache_buffer_size,
            "packet_cache_13": packet_cache_buffer_size,
            "packet_cache_14": packet_cache_buffer_size,
            "packet_cache_15": packet_cache_buffer_size,
        },
        external_args={
            "weight": [
                "W_norm1_0",
