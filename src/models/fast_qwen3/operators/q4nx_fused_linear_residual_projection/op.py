...
@dataclass
class Q4NXFusedLinearResidualProjection(MLIROperator):
    """Packed Q4NX projection block followed by residual add in one ELF."""
    ...
    def __post_init__(self) -> None:
        ...
        if self.k_chunks > 8:
            raise ValueError(
                "Q4NXFusedLinearResidualProjection currently supports at most 2048 K"
            )
    ...
    def weight_stream_bytes(self) -> int:
        return self.output_patches * 2 * self.k_chunks * Q4NX_CHUNK_BYTES
    ...
    def _kernel_object_name(self) -> str:
        return (
            "q4nx_fused_linear_residual_projection_"
    ...
    def get_mlir_artifact(self):
        ...
        return PythonGeneratedMLIRArtifact(
            ...
            DesignGenerator(
                ...
                "q4nx_fused_linear_residual_projection",
                (
    ...
    def get_arg_spec(self):
        return [
            ...
            AIERuntimeArgSpec("in", (self.output_elements,), dtype=bfloat16),
