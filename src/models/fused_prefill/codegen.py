...
"""Generate fused_prefill runtime code directly from torch.export graphs."""
...
from models.fused_prefill.dump_exported_program import export_program
from models.fused_prefill.pytorch_modules import LlamaExportConfig
...
def _parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(
        description="Generate fused_prefill runtime code from torch.export graphs"
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
